...
<div class="container">
    <div class="header">
        ...
        <div class="texto-cadastro">
            <h1>Cadastrar Veículo</h1> <!-- Use h1 for the main title -->
            </div>
            ...
            <form action="create.php" method="POST"> <!-- Formulário para cadastrar veículo -->
            ...
            <p> <label for="placa">Placa do Veículo (exemplo: ABC-1234):</p></label> <!-- Rótulo do campo de entrada de placa -->
                ...
                <button type="submit">Cadastrar Veículo</button> <!-- Botão para enviar o formulário de cadastro -->
                </div>
            </form>
       </div>
    </div>
