...
$sql = "SELECT * FROM capacidade_estacionamento";
...
if ($result->num_rows > 0) {
    echo '<table>';
    echo '<tr>';
    echo '<th>idcapacidade</th>';
    echo '<th>capacidade_total</th>';
    echo '<th>data_atualizacao</th>';
    //echo '<th>Saída</th>';
    //echo '<th>Ações</th>';
    echo '</tr>';
